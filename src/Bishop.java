public class Bishop extends ChessPiece {
    ...
    public boolean canMoveToPosition(ChessBoard chessBoard, int line, int column, int toLine, int toColumn) {
        if (line != toLine && column != toColumn && getMax(line, toLine) - getMin(line, toLine) ==
                ...
                checkPos(toLine) && checkPos(toColumn) && (chessBoard.board[toLine][toColumn] ==
                null || !chessBoard.board[toLine][toColumn].color.equals(this.color)) && chessBoard.board[line][column] != null) {
            ...
            return true;
            } else { int fromL = getMin(line, toLine);
                int fromC = getMin(column, toColumn);
