public class Queen extends ChessPiece {
    ...
    public boolean canMoveToPosition(ChessBoard chessBoard, int line, int column, int toLine, int toColumn) {
        if (line != toLine && column != toColumn && getMax(line, toLine) - getMin(line, toLine) ==
                getMax(column, toColumn) - getMin(column, toColumn) && checkPos(line) && checkPos(column) &&
                checkPos(toLine) && checkPos(toColumn) && (chessBoard.board[toLine][toColumn] == null ||
            ...
            if ((column == getMin(column, toColumn) && line == getMax(line, toLine)) ||
                ...
                for (int i = 1; i < toC - fromC; i++) {
                    if (chessBoard.board[fromL - i][fromC + i] == null) {
                        ...
                        positions[i - 1] = new int[]{fromL - i, fromL + i};
                    } else {
                        return false;
                    }
                }
            ...
            if (column == toColumn) {
                ...
                if (chessBoard.board[toLine][toColumn] != null) {
                    if (chessBoard.board[toLine][toColumn].getColor().equals(this.color) && chessBoard.board[toLine][column] != this) return false;
                    else return !chessBoard.board[toLine][toColumn].getColor().equals(this.color) && chessBoard.board[toLine][column] != this;
                } else return true;
            } else return false;
        } else return false;
    }
